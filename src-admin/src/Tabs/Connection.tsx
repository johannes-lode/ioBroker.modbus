...
const schema: ConfigItemPanel = {
    ...
    items: {
        ...
        proxy: {
            newLine: true,
            type: 'checkbox',
            label: 'Serve polled data as TCP slave',
            help: 'Additionally serve the polled data as a Modbus TCP slave',
            hidden: 'data.slave === "1" || data.slave === 1 || data.slave === true',
            xs: 12,
            sm: 6,
            lg: 4,
        ...
        proxyBind: {
            ...
            hidden: '!data.proxy || data.slave === "1" || data.slave === 1 || data.slave === true',
            xs: 12,
            sm: 6,
            lg: 4,
        },
